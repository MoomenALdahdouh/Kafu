...
<script>
import AdminLayout from "../../layouts/admin/IncubatorLayout.vue";
...
export default {
    ...
    methods: {
        updateData() {
            ...
            this.$inertia.get("/admin/incubator", this.params, {
                preserveState: true,
                preverseScroll: true,
                onSuccess: () => {
        ...
        destroy() {
            this.form.delete(route("admin.incubator.destroy", this.itemId), {
                preverseScroll: true,
                onSuccess: () => {
        ...
        submit() {
            if (this.isUpdate) {
                this.form.put(route("admin.incubator.update", this.itemId), {
                    preverseScroll: true,
                    onSuccess: () => {
                ...
                this.form.post(route("admin.incubator.store"), {
                    preverseScroll: true,
                    onSuccess: () => {
                        this.isLoading = false;
                        this.dialog = false;
