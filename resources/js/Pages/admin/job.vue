...
<script>
import AdminLayout from "../../layouts/admin/JobLayout.vue";
...
export default {
    ...
    methods: {
        updateData() {
            ...
            this.$inertia.get("/admin/job", this.params, {
                preserveState: true,
                preverseScroll: true,
                onSuccess: () => {
        ...
        destroy() {
            this.form.delete(route("admin.job.destroy", this.itemId), {
                preverseScroll: true,
                onSuccess: () => {
        ...
        submit() {
            if (this.isUpdate) {
                this.form.put(route("admin.job.update", this.itemId), {
                    preverseScroll: true,
                    onSuccess: () => {
                ...
                this.form.post(route("admin.job.store"), {
                    preverseScroll: true,
                    onSuccess: () => {
                        this.isLoading = false;
                        this.dialog = false;
